...
class PreguntasFormularioTableSeeder extends Seeder {
    public function run(){
        ...
        PreguntaFormulario::create(array('pregunta_id' => 2,'formulario_id' => 3,"ponderation" => 0 ));
        PreguntaFormulario::create(array('pregunta_id' => 3,'formulario_id' => 3,"ponderation" => 8.3 ));
        PreguntaFormulario::create(array('pregunta_id' => 4,'formulario_id' => 3,"ponderation" => 8.3 ));
        PreguntaFormulario::create(array('pregunta_id' => 5,'formulario_id' => 3,"ponderation" => 8.3 ));
        PreguntaFormulario::create(array('pregunta_id' => 6,'formulario_id' => 3,"ponderation" => 8.3 ));
        PreguntaFormulario::create(array('pregunta_id' => 7,'formulario_id' => 3,"ponderation" => 8.3 ));
        PreguntaFormulario::create(array('pregunta_id' => 8,'formulario_id' => 3,"ponderation" => 8.3 ));
        PreguntaFormulario::create(array('pregunta_id' => 9,'formulario_id' => 3,"ponderation" => 8.3 ));
        PreguntaFormulario::create(array('pregunta_id' => 10,'formulario_id' => 3,"ponderation" => 8.3 ));
