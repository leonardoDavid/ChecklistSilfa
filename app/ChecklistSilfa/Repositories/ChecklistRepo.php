    ...
    */
	...
	public static function reports($filters = array()){
        ...
        return $query->join('area','area.id','=','checklist.area_id')
        	...
        	->select('area.nombre as area','sucursal.nombre as sucursal','local.nombre as local','user.nombre as user','user.ape_paterno as apellido','checklist.created_at as created_at','checklist.id as id','checklist.comentario as comentario_final')
